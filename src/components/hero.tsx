        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div>
              ...
              >
                {t('greeting')} <span className="gradient-text">Nicolas</span>
              </motion.h1>
              <motion.p 
            ...
            >
              <Link href="https://github.com/NicolasBianchini" isExternal aria-label="GitHub">
          ...
          >
            <div className="relative w-72 h-72 md:w-96 md:h-96">
              ...
              <img 
                src="https://img.heroui.chat/image/avatar?w=400&h=400&u=42"
                alt="Nicolas Bianchini"
